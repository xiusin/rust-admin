pub use crate::domain::args::a_dict_type::*;
pub use crate::domain::entity::sys_dict_type::{self, ActiveModel, Model as SysDictTypeModel};
use super::m_dict_data::SysDictDataModel;
