    ...
    <template #optional="{ record }">
      <a-space>
        ...
        <a-dropdown trigger="click">
          ...
          <template #content>
            <a-doption @click="emit('edit', record)"> <icon-edit /> 编辑 </a-doption>
            <a-doption @click="emit('copy', record)"> <icon-copy /> 复制 </a-doption>
            <a-doption @click="emit('toggle-status', record)"> <icon-swap /> {{ record.isEnabled ? "禁用" : "启用" }} </a-doption>
            <a-doption @click="handleDelete(record)"> <icon-delete /> 删除 </a-doption>
          </template>
        </a-dropdown>
      </a-space>
    </template>
