<template>
  <div class="snow-page">
    <a-card title="简介">
      <div>
        <p>EcomAdmin 一款基于 Vue、TypeScript、Vite5、Pinia、arco.design开源的后台管理框架，使用目前最新技术栈开发。</p>
...
const projectInfo: any = [
  ...
  },
  {
    label: "GitHub",
    link: true,
    value: "https://github.com/WangFan-io/EcomAdmin"
  },
  {
    label: "Gitee",
    link: true,
    value: "https://gitee.com/wang_fan_w/EcomAdmin"
  },
  {
    label: "文档地址",
    link: true,
