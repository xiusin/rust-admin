export const license = {
  list: (params?: { pageNum?: number; pageSize?: number }) =>
    axios.get('/plugin/license/list', { params }),
  ...
  unbind: (data: { licenseId: number; deviceId: string }) =>
    axios.post('/plugin/license/unbind', data),
  renew: (data: { licenseId: number; extendDays: number }) =>
    axios.post('/plugin/license/renew', data),
...
export const subscription = {
  list: (params?: { pageNum?: number; pageSize?: number }) =>
    axios.get('/plugin/subscription/list', { params }),
  renew: (data: { subscriptionId: number; extendDays: number }) =>
    axios.post('/plugin/subscription/renew', data),
