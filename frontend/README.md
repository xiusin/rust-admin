...
<div>
	<p>
    <a href="https://github.com/WangFan-io/EcomAdmin" target="_blank">
...
EcomAdmin 是一个清新优雅、高颜值且功能强大的后台管理模板，基于最新的前端技术栈，包括 Vue3, Vite6, TypeScript, Pinia。它内置了丰富的主题配置和组件，代码规范严谨，实现了自动化的文件路由系统。EcomAdmin 为您提供了一站式的后台管理解决方案，无需额外配置，开箱即用。同样是一个快速学习前沿技术的最佳实践。

### 版本 📦

**预览及文档**

项目预览地址：[EcomAdmin](http://115.190.79.132/#/login)

项目文档地址：[EcomAdmin-开发指南](http://115.190.79.132:81/)

**代码仓库**

| 平台   | 仓库地址                                               |
| ------ | ------------------------------------------------------ |
| GitHub | [Github 仓库](https://github.com/WangFan-io/EcomAdmin) |
| Gitee  | [Gitee 仓库](https://gitee.com/wang_fan_w/EcomAdmin)   |
...
```bash
# 克隆代码
git clone https://github.com/WangFan-io/EcomAdmin.git
```
...
```bash
# 克隆代码
git clone https://gitee.com/wang_fan_w/EcomAdmin.git
```
...
如果觉得框架不错，或者已经在使用了，希望你可以去 [GitHub](https://github.com/WangFan-io/EcomAdmin) ⭐ Star，这将是对我极大的鼓励与支持。

### 免责条款 📫

您充分了解并同意，您必须为自己使用本服务及注册帐号下的一切行为负责，包括您所发表的任何内容以及由此产生的任何后果。您应对本服务中的内容自行加以判断，并自行承担因使用内容而引起的所有风险。

`EcomAdmin` 对网站上所显示的信息或资料的准确性、内容、完整性、合法性、可靠性、可操作性或可用性不承担任何责任。

`EcomAdmin` 二次开发使用者因为违法而触犯中华人民共和国法律的，一切后果自己负责，`EcomAdmin` 作者不承担任何责任。

本声明未涉及的问题参见国家有关法律法规，当本声明与国家法律法规冲突时，以国家法律法规为准。

### 学习 & 商用 🌈

`EcomAdmin` 是免费和开源的，可免费用于学习、商业使用 。
