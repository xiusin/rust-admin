...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.ColorStore = exports.ColorType = exports.colorEqual = void 0;

const vutils_1 = require("@visactor/vutils");

function colorEqual(color1, color2) {
    const c1 = vutils_1.Color.parseColorString(color1), c2 = vutils_1.Color.parseColorString(color2);
    return !(!c1 || !c2) && (c1.r === c2.r && c1.g === c2.g && c1.b === c2.b && c1.opacity === c2.opacity);
}

var ColorType;

exports.colorEqual = colorEqual, function(ColorType) {
...
class ColorStore {
    static Get(str, size = ColorType.Color1, arr = [ 0, 0, 0, 1 ]) {
        if (size === ColorType.Color1) {
            ...
            arr;
            const c = vutils_1.Color.parseColorString(str);
            if (c) {
