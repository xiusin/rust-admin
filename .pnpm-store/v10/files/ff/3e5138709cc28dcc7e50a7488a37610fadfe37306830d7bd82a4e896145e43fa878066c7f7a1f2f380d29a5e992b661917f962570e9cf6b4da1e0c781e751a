...
const event_1 = require("./../constant/event"), vgrammar_core_1 = require("@visactor/vgrammar-core"), compilable_item_1 = require("./interface/compilable-item"), util_1 = require("./util"), env_1 = require("../util/env"), type_1 = require("../util/type"), vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core");
...
class Compiler {
    ...
    initView() {
        ...
        this._view = new vgrammar_core_1.View(Object.assign(Object.assign({
            ...
            mode: (0, util_1.toRenderMode)(mode),
            autoFit: !1,
            eventConfig: {
                gesture: (0, vutils_1.isValid)(gestureConfig) ? gestureConfig : (0, env_1.isMobileLikeMode)(mode),
    ...
    clearNextRender() {
        return !!this._nextRafId && (vrender_core_1.vglobal.getCancelAnimationFrame()(this._nextRafId), 
    ...
    renderNextTick(morphConfig) {
        this._released || this._nextRafId || (this._nextRafId = vrender_core_1.vglobal.getRequestAnimationFrame()((() => {
