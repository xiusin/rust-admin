...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.MarkTooltipProcessor = void 0;

const base_1 = require("./base"), vrender_core_1 = require("@visactor/vrender-core");
            ...
            if (activeTriggers) {
                ...
                layer.globalTransMatrix.transformPoint({
                    ...
                    mark.getProductElements().forEach((el => {
                        ...
                        el !== params.item && graphic && graphic.containsPoint(point.x, point.y, vrender_core_1.IContainPointMode.GLOBAL, graphic.stage.getPickerService()) && tooltipData[0].datum.push(el.getDatum());
                    }));
                }));
            }
        }
