...
import { mixin, clamp, isNil, merge, isEqual, isValid, array, minInArray, maxInArray, abs, last } from "@visactor/vutils";
    ...
    _initData() {
        ...
        if (this._relatedAxisComponent) {
            ...
            eachSeries(this._regions, (s => {
                ...
                isValidateStateAxis ? stateFields.push(originalStateFields[s.id]) : stateFields.push(originalStateFields[s.id][0]), 
                this._valueField) {
