...
const vrender_core_1 = require("@visactor/vrender-core"), plugin_service_1 = require("../../plugin/components/plugin-service"), vutils_1 = require("@visactor/vutils"), event_1 = require("../../constant/event"), animate_manager_1 = require("../../animation/animate-manager"), layout_model_1 = require("../../model/layout-model"), base_component_transformer_1 = require("./base-component-transformer");
...
class BaseComponent extends layout_model_1.LayoutModel {
    ...
    constructor(spec, options) {
        super(spec, options), this.name = "component", this.modelType = "component", this.transformerConstructor = base_component_transformer_1.BaseComponentSpecTransformer, 
