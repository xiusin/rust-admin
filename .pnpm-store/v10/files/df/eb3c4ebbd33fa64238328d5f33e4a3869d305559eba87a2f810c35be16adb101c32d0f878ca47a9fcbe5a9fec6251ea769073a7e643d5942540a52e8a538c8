...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.SankeyHighlight = void 0;

const vgrammar_core_1 = require("@visactor/vgrammar-core"), vutils_1 = require("@visactor/vutils");

class SankeyHighlight extends vgrammar_core_1.BaseInteraction {
    constructor(view, options) {
        ...
        super(view, options), this.type = SankeyHighlight.type, this.highlightAdjacentElement = (element, isNode) => {
            ...
            return allLinkElements.forEach((linkEl => {
                const linkDatum = linkEl.getDatum(), originalDatum = (0, vutils_1.array)(linkDatum.datum);
    ...
    parseUpstreamLinks(element, isNode) {
        ...
        return (isNode ? datum.targetLinks : (0, vutils_1.array)(datum)).reduce(((res, link) => ((0, 
...
exports.SankeyHighlight = SankeyHighlight, SankeyHighlight.type = "sankey-highlight", 
SankeyHighlight.defaultOptions = {
    highlightState: vgrammar_core_1.InteractionStateEnum.highlight,
    blurState: vgrammar_core_1.InteractionStateEnum.blur,
    trigger: "pointerover",
