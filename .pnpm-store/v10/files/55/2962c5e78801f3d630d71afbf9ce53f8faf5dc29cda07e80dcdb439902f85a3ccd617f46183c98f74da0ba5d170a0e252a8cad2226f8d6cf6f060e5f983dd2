...
class Player extends base_component_1.BaseComponent {
    ...
    changePlayerIndex(index) {
        ...
        })), this.event.emit(event_1.ChartEvent.playerChange, {
            model: this,
            value: {
                spec: spec,
                index: index,
...
exports.Player = Player, Player.specKey = "player", Player.type = type_1.ComponentTypeEnum.player;
