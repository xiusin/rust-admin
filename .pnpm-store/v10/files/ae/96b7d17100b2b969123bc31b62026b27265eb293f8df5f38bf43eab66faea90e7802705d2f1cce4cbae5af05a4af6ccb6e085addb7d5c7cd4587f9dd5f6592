...
class PolarAxis extends base_axis_1.AxisComponent {
    ...
    _update(attrs) {
        ...
        if (this._axisMark.getProduct().encode((0, vutils_extension_1.mergeSpec)({}, this._axisStyle, axisAttrs)), 
        this._gridMark) {
            this._gridMark.getProduct().encode((0, vutils_extension_1.mergeSpec)({}, this._gridStyle, gridAttrs));
        }
    }
    invert(value) {
        var _a;
