...
const vutils_1 = require("@visactor/vutils"), vgrammar_util_1 = require("@visactor/vgrammar-util"), correlation_1 = require("../../constant/correlation"), correlation = (data, options) => {
    ...
    vgrammar_util_1.toPercent)(null !== (_f = null === (_e = options.center) || void 0 === _e ? void 0 : _e[0]) && void 0 !== _f ? _f : "50%", viewBox.x1 - viewBox.x0), (0, 
    vutils_1.isNumber)(null === (_g = options.center) || void 0 === _g ? void 0 : _g[1]) ? options.center[1] : viewBox.y0 + (0, 
    vgrammar_util_1.toPercent)(null !== (_j = null === (_h = options.center) || void 0 === _h ? void 0 : _h[1]) && void 0 !== _j ? _j : "50%", viewBox.y1 - viewBox.y0) ], fieldAccessor = (0, 
    vgrammar_util_1.field)(options.field), values = data.map(fieldAccessor), [min, max] = (0, 
    ...
    if (sizeAccessor) {
        const [minSize, maxSize] = sizeAccessor !== fieldAccessor ? (0, vgrammar_util_1.extent)(data.map(sizeAccessor)) : [ min, max ], minR = null !== (_o = null === (_m = options.radiusRange) || void 0 === _m ? void 0 : _m[0]) && void 0 !== _o ? _o : 5, maxR = null !== (_q = null === (_p = options.radiusRange) || void 0 === _p ? void 0 : _p[1]) && void 0 !== _q ? _q : 5;
