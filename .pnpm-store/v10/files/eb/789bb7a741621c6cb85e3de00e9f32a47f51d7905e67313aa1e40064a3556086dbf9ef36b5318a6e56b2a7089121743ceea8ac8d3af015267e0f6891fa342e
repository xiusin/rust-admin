...
const vutils_extension_1 = require("@visactor/vutils-extension"), color_1 = require("../../util/color"), scale_1 = require("../../util/scale"), gradient_1 = require("../../constant/gradient"), attribute_1 = require("../../constant/attribute"), vscale_1 = require("@visactor/vscale"), util_1 = require("../../theme/color-scheme/util"), compilable_mark_1 = require("../../compile/mark/compilable-mark"), vutils_1 = require("@visactor/vutils"), utils_1 = require("../utils");
...
class BaseMark extends compilable_mark_1.CompilableMark {
    ...
    initStyleWithSpec(spec, key) {
        ...
        vutils_1.isBoolean)(spec.visible) && this.setVisible(spec.visible), this._initSpecStyle(spec, this.stateStyle, key));
    }
    ...
    _filterAttribute(attr, style, state, level, isUserLevel, stateStyle = this.stateStyle) {
        ...
        if (isUserLevel) switch (attr) {
          ...
          case "curveType":
            newStyle = this._transformStyleValue(newStyle, (value => (0, utils_1.curveTypeTransform)(value, this._option.model.direction)));
        }
        return newStyle;
    }
    ...
    setAttribute(attr, style, state = "normal", level = 0, stateStyle = this.stateStyle) {
        ...
        (0, vutils_1.isValid)(attrLevel) && attrLevel <= level && (0, vutils_extension_1.mergeSpec)(stateStyle[state][attr], {
            style: style,
            level: level
    ...
    _initSpecStyle(spec, stateStyle, key) {
        spec.style && this.setStyle(spec.style, "normal", attribute_1.AttributeLevel.User_Mark, stateStyle);
        ...
        state && Object.keys(state).forEach((key => {
            ...
            if ("style" in stateTemp) {
                ...
                this.state.addStateInfo(stateInfo), this.setStyle(style, key, attribute_1.AttributeLevel.User_Mark, stateStyle);
            } else this.setStyle(stateTemp, key, attribute_1.AttributeLevel.User_Mark, stateStyle);
        }));
    }
    ...
    _computeBorderAttr(borderStyle) {
        ...
        return (data, opt) => {
            ...
            })), "stroke" in computeStyle) gradient_1.GradientType.includes(null === (_c = mergedStyle.stroke) || void 0 === _c ? void 0 : _c.gradient) && (computeStyle.stroke = this._computeGradientAttr(mergedStyle.stroke)(data, opt)); else {
