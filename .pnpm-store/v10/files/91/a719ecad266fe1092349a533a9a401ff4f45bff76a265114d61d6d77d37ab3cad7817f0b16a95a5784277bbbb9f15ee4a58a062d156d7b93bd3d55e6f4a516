...
const vutils_1 = require("@visactor/vutils"), util_1 = require("../util"), vutils_extension_1 = require("@visactor/vutils-extension"), vgrammar_core_1 = require("@visactor/vgrammar-core");
...
function calculateChartSize(spec, option, defaultSize) {
    ...
    if (container) {
        ...
        let canvasNode;
        canvasNode = (0, vutils_1.isString)(canvas) ? vgrammar_core_1.vglobal.getElementById(canvas) : canvas;
