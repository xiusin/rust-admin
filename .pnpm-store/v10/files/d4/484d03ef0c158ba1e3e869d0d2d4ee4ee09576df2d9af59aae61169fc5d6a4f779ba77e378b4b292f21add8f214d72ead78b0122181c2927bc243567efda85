...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.registerPie3dAnimation = exports.registerEmptyCircleAnimation = exports.registerPieAnimation = exports.piePresetAnimation = exports.pieDisappear = exports.pieExit = exports.pieEnter = exports.Appear_FadeIn = exports.Appear_Grow = exports.pieGrowOption = void 0;
...
function pieGrowOption(pieParams, isOverall, state) {
    return (datum, element, params) => isOverall ? "radius" === pieParams.growField ? {
        overall: 0
    } : {
...
const registerPie3dAnimation = () => {
    factory_1.Factory.registerAnimation("pie3d", ((params, preset) => ({
        appear: piePresetAnimation(params, preset),
        enter: (0, exports.pieEnter)(params),
        exit: (0, exports.pieExit)(params),
        disappear: (0, exports.pieDisappear)(params)
...
exports.registerPie3dAnimation = registerPie3dAnimation;
