...
class DomTooltipHandler extends base_1.BaseTooltipHandler {
    ...
    initRootDom() {
        var _a, _b, _c;
        const tooltipSpec = this._component.getSpec(), tooltipElement = document.createElement("div"), globalTheme = null !== (_b = null === (_a = this._chartOption) || void 0 === _a ? void 0 : _a.getTheme()) && void 0 !== _b ? _b : {};
    ...
    _updateDomStringByCol(actualTooltip) {
        ...
        if (!contentDom && hasContent && (contentDom = document.createElement("div"), columns.forEach((col => {
            ...
            colDiv.classList.add(`${constants_1.TOOLTIP_PREFIX}-column`), colDiv.classList.add(`${constants_1.TOOLTIP_PREFIX}-${col}-column`), 
            colDiv.setAttribute("data-col", col), contentDom.appendChild(colDiv);
        })), contentDom.classList.add(constants_1.TOOLTIP_CONTENT_BOX_CLASS_NAME), this._rootDom.appendChild(contentDom)), 
        contentDom && hasContent) {
            const columnDivs = [ ...contentDom.children ];
            (0, style_1.setStyleToDom)(contentDom, {
                whiteSpace: "nowrap"
                ...
                if (colName && columns.includes(colName)) {
                    ...
                    (0, style_1.setStyleToDom)(colDiv, Object.assign(Object.assign({}, this._domStyle[colName]), {
                    ...
                    rows.slice(content.length).forEach((extraRow => {
                        ...
                        let row = rows[index];
                        row || (row = document.createElement("div"), row.classList.add(`${constants_1.TOOLTIP_PREFIX}-${colName}`), 
                        ...
                        styleByRow.height = "initial", "key" === colName ? (row.innerHTML = (0, common_1.formatContent)(entry.key), 
                        entry.keyStyle && (0, style_1.getTextStyle)(entry.keyStyle, styleByRow)) : "value" === colName ? (row.innerHTML = (0, 
                        common_1.formatContent)(entry.value), entry.valueStyle && (0, style_1.getTextStyle)(entry.valueStyle, styleByRow)) : "shape" === colName && (row.innerHTML = (0, 
                        svg_1.getSvgHtml)(entry, `${this.id}_${index}`)), (0, style_1.setStyleToDom)(row, styleByRow);
                    }));
                }
            }));
    ...
    _updateDomStyle(sizeKey = "width") {
        ...
        if (contentDom) {
            ...
            if ((0, vutils_1.isValid)(null === (_b = null == tooltipSpec ? void 0 : tooltipSpec.style) || void 0 === _b ? void 0 : _b.maxContentHeight)) {
                const titleHeight = titleDom && titleDom.className.includes(constants_1.TOOLTIP_TITLE_CLASS_NAME) ? titleDom.getBoundingClientRect().height + (null !== (_c = tooltipSpec.style.spaceRow) && void 0 !== _c ? _c : 0) : 0, viewRect = this._chartOption.getChartViewRect(), maxHeight = (0, 
