...
export class BaseMarkPoint extends BaseMarker {
    ...
    _createMarkerComponent() {
        ...
        (null == symbol ? void 0 : symbol.style) && (markPointAttrs.itemContent.symbolStyle = transformToGraphic(transformStyle(symbol.style, this._markerData, this._markAttributeContext))), 
        (null == image ? void 0 : image.style) && (markPointAttrs.itemContent.imageStyle = transformStyle(image.style, this._markerData, this._markAttributeContext)), 
        label && (markPointAttrs.itemContent.textStyle = transformLabelAttributes(label, this._markerData, this._markAttributeContext)), 
        (null == richText ? void 0 : richText.style) && (markPointAttrs.itemContent.richTextStyle = transformStyle(richText.style, this._markerData, this._markAttributeContext));
