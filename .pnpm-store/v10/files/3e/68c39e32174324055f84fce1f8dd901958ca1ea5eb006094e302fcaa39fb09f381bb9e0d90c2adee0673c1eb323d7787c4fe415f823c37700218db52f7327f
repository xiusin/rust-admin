...
const vutils_1 = require("@visactor/vutils"), vutils_extension_1 = require("@visactor/vutils-extension"), type_1 = require("../../interface/type"), data_filter_base_component_1 = require("../data-filter-base-component"), vrender_components_1 = require("@visactor/vrender-components"), style_1 = require("../../../util/style"), vscale_1 = require("@visactor/vscale"), layout_1 = require("../../../constant/layout"), event_1 = require("../../../constant/event"), factory_1 = require("../../../core/factory"), data_zoom_transformer_1 = require("./data-zoom-transformer"), util_1 = require("../../util");
...
class DataZoom extends data_filter_base_component_1.DataFilterBaseComponent {
    ...
    onLayoutEnd(ctx) {
        ...
        this.effect.onZoomChange()), !1 !== this._cacheVisibility && super.onLayoutEnd(ctx);
    }
    _initValueScale() {
