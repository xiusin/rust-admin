...
class BaseSeries extends base_model_1.BaseModel {
    ...
    created() {
        ...
        this._option.disableTriggerEvent || this.initInteraction(), this.afterInitMark(), 
        this.initEvent(), this.event.emit(event_1.ChartEvent.afterInitEvent, {
            model: this
        });
    }
    ...
    initData() {
        ...
        this._addDataIndexAndKey(), this._rawData) {
            ...
            this._data = new series_data_1.SeriesData(this._option, viewData), this.getStack() && this._viewDataFilter.target.removeListener("change", viewData.reRunAllTransform);
        }
    ...
    _initExtensionMark(options) {
        ...
        options.depend = mainMarks, null === (_a = this._spec.extensionMark) || void 0 === _a || _a.forEach(((m, i) => {
    ...
    _createMark(markInfo, option = {}, config = {}) {
        ...
        const {key: key, groupKey: groupKey, skipBeforeLayouted: skipBeforeLayouted, themeSpec: themeSpec = {}, markSpec: markSpec, dataView: dataView, dataProductId: dataProductId, parent: parent, isSeriesMark: isSeriesMark, depend: depend, stateSort: stateSort, noSeparateStyle: noSeparateStyle = !1} = option, m = super._createMark(markInfo, {
        ...
        if ((0, vutils_1.isValid)(m)) {
            ...
            (0, vutils_1.isValid)(depend) && m.setDepend(...(0, vutils_1.array)(depend)), (0, 
            vutils_1.isNil)(groupKey) || m.setGroupKey(groupKey), stateSort && m.setStateSortCallback(stateSort);
            const markConfig = Object.assign(Object.assign({}, config), {
                morph: null !== (_b = config.morph) && void 0 !== _b && _b,
                support3d: (0, utils_2.is3DMark)(markInfo.type) || (null !== (_c = config.support3d) && void 0 !== _c ? _c : spec.support3d || !!spec.zField),
                morphKey: (null === (_d = spec.morph) || void 0 === _d ? void 0 : _d.morphKey) || `${this.getSpecIndex()}_${this.getMarks().length}`,
                morphElementKey: null !== (_f = null === (_e = spec.morph) || void 0 === _e ? void 0 : _e.morphElementKey) && void 0 !== _f ? _f : config.morphElementKey
            });
