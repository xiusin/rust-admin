...
const type_1 = require("../interface/type"), base_component_1 = require("../base/base-component"), env_1 = require("../../util/env"), show_tooltip_1 = require("./utils/show-tooltip"), common_1 = require("./utils/common"), common_2 = require("../../event/events/dimension/util/common"), event_1 = require("../../constant/event"), processor_1 = require("./processor"), util_1 = require("./processor/util"), vutils_1 = require("@visactor/vutils"), vchart_1 = require("../../core/vchart"), factory_1 = require("../../core/factory"), tooltip_transformer_1 = require("./tooltip-transformer"), util_2 = require("../../util"), constant_1 = require("./constant");
...
class Tooltip extends base_component_1.BaseComponent {
    constructor() {
        ...
        this._eventList = [], this._isTooltipShown = !1, this._clickLock = !1, this._mountEvent = (eType, query, callback) => {
            ...
            for (let i = 0, len = constant_1.TOOLTIP_TYPES.length; i < len; i++) {
                const type = constant_1.TOOLTIP_TYPES[i];
    ...
    _initEventOfTooltipContent() {
        ...
        container && (container.addEventListener("pointerenter", (() => {
            ...
            var _a, _b, _c;
            if (this._enterable && (this._isEnterTooltip = !1, this._cacheEnterableRect)) {
    ...
    _initProcessor() {
        ...
        activeType.includes("group") && (this.processor.group = new processor_1.GroupTooltipProcessor(this)), 
        activeType.includes("mark") && (this.processor.mark = new processor_1.MarkTooltipProcessor(this));
    }
    _initEvent() {
        var _a;
