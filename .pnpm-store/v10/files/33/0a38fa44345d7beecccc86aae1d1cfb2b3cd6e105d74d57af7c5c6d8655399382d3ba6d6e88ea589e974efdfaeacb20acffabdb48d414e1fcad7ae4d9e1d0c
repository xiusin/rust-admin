...
const vutils_1 = require("@visactor/vutils"), factory_1 = require("../core/factory"), graphic_1 = require("../graph/mark/graphic"), vgrammar_util_1 = require("@visactor/vgrammar-util"), glyph_1 = require("../view/glyph"), scaleIn = computeCenter => (element, options, animationParameters) => {
    ...
    return config && (0, vgrammar_util_1.isHorizontal)(config.direction) ? ((0, vutils_1.isValidNumber)(boxHeight) ? (Object.assign(attributes.box, {
        ...
        y: y - height / 2,
        y1: y + height / 2
    })), (0, vutils_1.isValidNumber)(ruleHeight) ? (Object.assign(attributes.max, {
        y: y - ruleHeight / 2,
        y1: y + ruleHeight / 2
        ...
        x: x - width / 2,
        x1: x + width / 2
    })), (0, vutils_1.isValidNumber)(ruleWidth) ? (Object.assign(attributes.max, {
        x: x - ruleWidth / 2,
        x1: x + ruleWidth / 2
    }), Object.assign(attributes.min, {
        x: x - ruleWidth / 2,
...
function registerBoxplotGlyph() {
    factory_1.Factory.registerGlyph("boxplot", {
        shaft: "rule",
        box: "rect",
        max: "rule",
        min: "rule",
...
exports.registerBoxplotGlyph = registerBoxplotGlyph;
...
const computeBarBoxplotCenter = (glyphElement, direction, options) => {
    ...
    return config && (0, vgrammar_util_1.isHorizontal)(config.direction) ? ((0, vutils_1.isValidNumber)(minMaxHeight) ? Object.assign(attributes.minMaxBox, {
        ...
        y: y - height / 2,
        y1: y + height / 2
    }), (0, vutils_1.isValidNumber)(q1q3Height) ? (Object.assign(attributes.q1q3Box, {
        y: y - q1q3Height / 2,
        y1: y + q1q3Height / 2
    }), Object.assign(attributes.median, {
        y: y - q1q3Height / 2,
        ...
        y: y - height / 2,
        y1: y + height / 2
    }))) : ((0, vutils_1.isValidNumber)(minMaxWidth) ? Object.assign(attributes.minMaxBox, {
        x: x - minMaxWidth / 2,
        x1: x + minMaxWidth / 2
    }) : Object.assign(attributes.minMaxBox, {
        x: x - width / 2,
        x1: x + width / 2
    }), (0, vutils_1.isValidNumber)(q1q3Width) ? (Object.assign(attributes.q1q3Box, {
        x: x - q1q3Width / 2,
        x1: x + q1q3Width / 2
    }), Object.assign(attributes.median, {
        x: x - q1q3Width / 2,
...
function registerBarBoxplotGlyph() {
    factory_1.Factory.registerGlyph("barBoxplot", {
        minMaxBox: "rect",
        q1q3Box: "rect",
        median: "rule"
...
exports.registerBarBoxplotGlyph = registerBarBoxplotGlyph;
