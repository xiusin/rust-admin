...
export class Tooltip extends BaseComponent {
    ...
    _initProcessor() {
        ...
        this.processor = {}, activeType.includes("dimension") && (this.processor.dimension = new DimensionTooltipProcessor(this)), 
        activeType.includes("group") && (this.processor.group = new GroupTooltipProcessor(this)), 
        activeType.includes("mark") && (this.processor.mark = new MarkTooltipProcessor(this));
    }
    _initEvent() {
        var _a;
