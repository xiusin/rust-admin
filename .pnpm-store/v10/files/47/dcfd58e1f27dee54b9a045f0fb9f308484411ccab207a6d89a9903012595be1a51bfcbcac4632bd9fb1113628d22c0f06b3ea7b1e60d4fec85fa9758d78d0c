...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.registerViolinGlyph = void 0;

const vutils_1 = require("@visactor/vutils"), factory_1 = require("../core/factory"), graphic_1 = require("../graph/mark/graphic"), vgrammar_util_1 = require("@visactor/vgrammar-util"), glyph_1 = require("../view/glyph"), defaultDensitySize = 30, computeViolinPoints = (density, densitySize, scale, config) => {
    if (!density || 0 === density.length) return [];
    const maxDensity = density.reduce(((max, d) => Math.max(max, d[1])), 0);
    if (config && (0, vgrammar_util_1.isHorizontal)(config.direction)) {
    ...
    return config && (0, vgrammar_util_1.isHorizontal)(config.direction) ? (0, vutils_1.isValidNumber)(boxHeight) ? Object.assign(attributes.box, {
        ...
        y: y - height / 2,
        y1: y + height / 2
    }) : (0, vutils_1.isValidNumber)(boxWidth) ? Object.assign(attributes.box, {
        x: x - boxWidth / 2,
        x1: x + boxWidth / 2
    }) : Object.assign(attributes.box, {
        x: x - width / 2,
    ...
    factory_1.Factory.registerGlyph("violin", {
        violin: "polygon",
        shaft: "rule",
        box: "rect",
        median: "symbol"
    }).registerFunctionEncoder(encodeViolin).registerChannelEncoder("x", ((channel, encodeValue, encodeValues, datum, element, config) => config && (0, 
    ...
    graphic_1.registerPolygonGraphic)(), (0, graphic_1.registerRuleGraphic)(), (0, graphic_1.registerRectGraphic)(), 
    (0, graphic_1.registerSymbolGraphic)();
};

exports.registerViolinGlyph = registerViolinGlyph;
