...
const vrender_core_1 = require("@visactor/vrender-core"), factory_1 = require("../../core/factory"), animation_1 = require("../polar/animation"), config_1 = require("../../animation/config"), vrender_kits_1 = require("@visactor/vrender-kits"), radarFadeAnimation = animationType => ({
...
const radarGroupClipAnimation = (params, animationType) => ({
    custom: vrender_core_1.ClipAngleAnimate,
