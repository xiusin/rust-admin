...
const factory_1 = require("./../core/factory"), type_1 = require("../series/interface/type"), base_line_1 = require("./base/base-line"), vgrammar_core_1 = require("@visactor/vgrammar-core"), config_1 = require("../animation/config");
...
const registerLineMark = () => {
    factory_1.Factory.registerMark(LineMark.type, LineMark), (0, vgrammar_core_1.registerLineGraphic)(), 
