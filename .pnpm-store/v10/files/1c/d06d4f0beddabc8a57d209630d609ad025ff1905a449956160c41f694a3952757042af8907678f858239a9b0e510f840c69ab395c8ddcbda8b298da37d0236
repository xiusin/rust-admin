...
!function(ComponentTypeEnum) {
    ...
    ComponentTypeEnum.sizeLegend = "sizeLegend", ComponentTypeEnum.mapLabel = "mapLabel", 
    ComponentTypeEnum.markLine = "markLine", ComponentTypeEnum.markArea = "markArea", 
    ComponentTypeEnum.markPoint = "markPoint", ComponentTypeEnum.polarMarkLine = "polarMarkLine", 
    ComponentTypeEnum.polarMarkArea = "polarMarkArea", ComponentTypeEnum.polarMarkPoint = "polarMarkPoint", 
    ComponentTypeEnum.geoMarkPoint = "geoMarkPoint", ComponentTypeEnum.tooltip = "tooltip", 
    ComponentTypeEnum.title = "title", ComponentTypeEnum.player = "player", ComponentTypeEnum.scrollBar = "scrollBar", 
    ComponentTypeEnum.label = "label", ComponentTypeEnum.totalLabel = "totalLabel", 
