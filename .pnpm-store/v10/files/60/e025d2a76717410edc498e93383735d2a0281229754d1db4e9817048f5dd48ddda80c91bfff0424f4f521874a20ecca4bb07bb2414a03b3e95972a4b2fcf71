...
import { registerRectDataLabel, registerLineDataLabel, registerArcDataLabel, registerSymbolDataLabel } from "@visactor/vrender-components";
...
export const registerAreaGraphic = () => {
    ...
    registerLineDataLabel(), registerSymbolDataLabel();
};
...
export const registerLineGraphic = () => {
    registerShadowRoot(), registerLine(), registerLineDataLabel(), registerSymbolDataLabel(), 
...
export const registerRectGraphic = () => {
    registerShadowRoot(), registerRect(), registerRectDataLabel(), Factory.registerGraphic(GrammarMarkType.rect, createRect);
};
...
export const registerSymbolGraphic = () => {
    registerShadowRoot(), registerSymbol(), registerSymbolDataLabel(), Factory.registerGraphic(GrammarMarkType.symbol, createSymbol);
};
...
export const registerCellGraphic = () => {
    registerShadowRoot(), registerSymbol(), registerSymbolDataLabel(), Factory.registerGraphic(GrammarMarkType.cell, createSymbol);
};

export const registerIntervalGraphic = () => {
    registerShadowRoot(), registerRect(), registerRectDataLabel(), registerArc(), registerArcDataLabel(), 
