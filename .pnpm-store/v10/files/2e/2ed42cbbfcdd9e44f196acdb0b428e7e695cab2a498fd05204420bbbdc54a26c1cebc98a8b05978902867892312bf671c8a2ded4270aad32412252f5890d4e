...
export class BaseSeries extends BaseModel {
    ...
    created() {
        ...
        this.initEvent(), this.event.emit(ChartEvent.afterInitEvent, {
            model: this
        });
    }
    ...
    _createMark(markInfo, option = {}, config = {}) {
        ...
        if (isValid(m)) {
            ...
            isNil(groupKey) || m.setGroupKey(groupKey), stateSort && m.setStateSortCallback(stateSort);
            const markConfig = Object.assign(Object.assign({}, config), {
                morph: null !== (_b = config.morph) && void 0 !== _b && _b,
                support3d: is3DMark(markInfo.type) || (null !== (_c = config.support3d) && void 0 !== _c ? _c : spec.support3d || !!spec.zField),
