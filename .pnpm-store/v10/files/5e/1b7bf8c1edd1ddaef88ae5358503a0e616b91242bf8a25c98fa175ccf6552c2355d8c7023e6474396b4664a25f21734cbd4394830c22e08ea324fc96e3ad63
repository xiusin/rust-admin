...
class VChart {
    ...
    static getSVG(key) {
        return (0, svg_source_1.getSVGSource)(key);
    }
    ...
    constructor(spec, options) {
        ...
        this.id = (0, id_1.createID)(), this._userEvents = [], this._autoSize = !0, this._option = {
            ...
            if (result.reSize = reSize, this._spec.type !== lastSpec.type) return null === (_b = null === (_a = this._compiler) || void 0 === _a ? void 0 : _a.getVGrammarView()) || void 0 === _b || _b.updateLayoutTag(), 
        ...
        instance_manager_1.InstanceManager.registerInstance(this), null === (_h = null === (_g = this._option.performanceHook) || void 0 === _g ? void 0 : _g.afterCreateVChart) || void 0 === _h || _h.call(_g, this);
    }
    ...
    _bindVGrammarViewEvent() {
        ...
        view.addEventListener(event_2.VGRAMMAR_HOOK_EVENT.ALL_ANIMATION_END, (() => {
            this._event.emit(event_2.ChartEvent.animationFinished, {
                chart: this._chart,
                vchart: this
            });
        })), view.addEventListener(event_2.VGRAMMAR_HOOK_EVENT.AFTER_VRENDER_NEXT_RENDER, (() => {
            this._event.emit(event_2.ChartEvent.renderFinished, {
                chart: this._chart,
                vchart: this
            });
        }));
    ...
    _reCompile(updateResult, morphConfig) {
        ...
        updateResult.reMake) null === (_d = this._compiler) || void 0 === _d || _d.releaseGrammar(!1 === (null === (_e = this._option) || void 0 === _e ? void 0 : _e.animation) || !1 === (null === (_f = this._spec) || void 0 === _f ? void 0 : _f.animation)), 
        this._userEvents.forEach((e => {
            var _a;
            return null === (_a = this._event) || void 0 === _a ? void 0 : _a.on(e.eType, e.query, e.handler);
        })), updateResult.reSize && this._doResize(); else if (updateResult.reCompile && (null === (_g = this._compiler) || void 0 === _g || _g.clear({
            chart: this._chart,
            vChart: this
        }, !1 === (null === (_h = this._option) || void 0 === _h ? void 0 : _h.animation) || !1 === (null === (_j = this._spec) || void 0 === _j ? void 0 : _j.animation)), 
        null === (_k = this._compiler) || void 0 === _k || _k.compile({
            chart: this._chart,
            vChart: this
        }, {})), updateResult.reSize) {
            const {width: width, height: height} = this.getCurrentSize();
    ...
    _afterRender() {
        return !this._isReleased && (this._updateAnimateState(), this._event.emit(event_2.ChartEvent.rendered, {
            chart: this._chart,
            vchart: this
        }), !0);
    }
    ...
    _updateAnimateState(initial) {
        ...
        if (this._option.animation) {
            const animationState = initial ? interface_1.AnimationStateEnum.appear : interface_1.AnimationStateEnum.update;
    ...
    release() {
        ...
        this._currentTheme = null, this._option = null, this._chart = null, this._compiler = null, 
        this._spec = null, this._specInfo = null, this._originalSpec = null, this._userEvents = null, 
        this._event = null, this._eventDispatcher = null, this._isReleased = !0, instance_manager_1.InstanceManager.unregisterInstance(this);
    }
    ...
    updateDataSync(id, data, parserOptions, userUpdateOptions) {
        return (0, util_1.isNil)(this._dataSet) ? this : this._chart ? ((null == userUpdateOptions ? void 0 : userUpdateOptions.reAnimate) && (this.stopAnimation(), 
        this._updateAnimateState(!0)), this._chart.updateData(id, data, !0, parserOptions), 
        this._compiler.render(), this) : (this._spec.data = (0, util_1.array)(this._spec.data), 
    ...
    _updateCurrentTheme(nextThemeName) {
        ...
        common_2.getThemeObject)(this._currentThemeName, !0), this._currentTheme = processThemeByChartType(chartType, currentTheme); else if ((0, 
        ...
        util_1.isString)(specTheme) && (!optionTheme || (0, util_1.isString)(optionTheme))) {
            const finalTheme = (0, theme_1.mergeTheme)({}, (0, common_2.getThemeObject)(this._currentThemeName, !0), (0, 
            ...
            this._currentTheme = (0, theme_1.preprocessTheme)(processThemeByChartType(chartType, finalTheme));
        }
    ...
    _getBackground() {
        return ("string" == typeof this._spec.background || (0, vutils_1.isObject)(this._spec.background) && this._spec.background.gradient ? this._spec.background : null) || this._currentTheme.background || this._option.background;
    }
    getCurrentTheme() {
...
const registerVChartCore = () => {
    ...
    (0, group_1.registerGroupMark)(), vgrammar_core_1.View.useRegisters([ vgrammar_core_1.registerGesturePlugin ]), 
    (0, interaction_1.registerElementHighlight)(), (0, interaction_1.registerElementSelect)(), 
