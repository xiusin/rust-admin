...
class FunnelSeries extends base_series_1.BaseSeries {
    ...
    initMark() {
        ...
        if (this._funnelMark = this._createMark(Object.assign(Object.assign({}, FunnelSeries.mark.funnel), {
            ...
            const {line: line} = null !== (_j = this._spec.outerLabel) && void 0 !== _j ? _j : {}, {line: lineTheme} = null !== (_l = null === (_k = this._theme) || void 0 === _k ? void 0 : _k.outerLabel) && void 0 !== _l ? _l : {};
    ...
    initLabelMarkStyle(labelMark) {
        ...
        }, "normal", attribute_1.AttributeLevel.Series), (null === (_a = this._funnelOuterLabelMark) || void 0 === _a ? void 0 : _a.label) && this._funnelOuterLabelMark.label.setDepend(component), 
    ...
    _computeOuterLabelLimit(datum) {
        ...
        const points = this.getPoints(datum), shapeMiddleWidth = (Math.abs(points[0].x - points[1].x) + Math.abs(points[2].x - points[3].x)) / 2, categoryField = this.getCategoryField(), funnelLabelBounds = null === (_e = null === (_d = null === (_c = null === (_b = null === (_a = this._labelMark) || void 0 === _a ? void 0 : _a.getComponent()) || void 0 === _b ? void 0 : _b.getProduct()) || void 0 === _c ? void 0 : _c.getGroupGraphicItem()) || void 0 === _d ? void 0 : _d.find((({attribute: attribute, type: type}) => {
            var _a;
            return "text" === type && (null === (_a = attribute.data) || void 0 === _a ? void 0 : _a[categoryField]) === datum[categoryField];
        }), !0)) || void 0 === _e ? void 0 : _e.AABBBounds, funnelLabelWidth = funnelLabelBounds ? funnelLabelBounds.x2 - funnelLabelBounds.x1 : 0, outerLineSpace = this._funnelOuterLabelMark.line ? this._minLabelLineWidth : 0;
        let space = this.getLayoutRect().width - Math.max(shapeMiddleWidth, funnelLabelWidth);
        return "center" === this._funnelAlign && (space /= 2), space - outerLineSpace - (null !== (_g = null === (_f = this._spec.outerLabel) || void 0 === _f ? void 0 : _f.spaceWidth) && void 0 !== _g ? _g : funnel_2.FUNNEL_LABEL_SPACE_WIDTH);
    }
    _computeOuterLabelLinePosition(datum) {
        ...
        }))) || void 0 === _e ? void 0 : _e.getBounds(), labelMarkBounds = null === (_k = null === (_j = null === (_h = null === (_g = null === (_f = this._labelMark) || void 0 === _f ? void 0 : _f.getComponent()) || void 0 === _g ? void 0 : _g.getProduct()) || void 0 === _h ? void 0 : _h.getGroupGraphicItem()) || void 0 === _j ? void 0 : _j.find((({attribute: attribute, type: type}) => {
            var _a;
            return "text" === type && (null === (_a = attribute.data) || void 0 === _a ? void 0 : _a[categoryField]) === datum[categoryField];
        }), !0)) || void 0 === _k ? void 0 : _k.AABBBounds, outerLabelSpec = null !== (_l = this._spec.outerLabel) && void 0 !== _l ? _l : {};
        let x1, x2, y1, y2;
        if (this._isHorizontal()) {
            const spaceWidth = null !== (_m = outerLabelSpec.spaceWidth) && void 0 !== _m ? _m : funnel_2.FUNNEL_LABEL_SPACE_WIDTH, points = this.getPoints(datum), shapeMiddleHeight = (Math.abs(points[0].y - points[1].y) + Math.abs(points[2].y - points[3].y)) / 2;
        ...
        const points = this.getPoints(datum), shapeMiddleWidth = (Math.abs(points[0].x - points[1].x) + Math.abs(points[2].x - points[3].x)) / 2, labelWidth = (null == labelMarkBounds ? void 0 : labelMarkBounds.x2) - (null == labelMarkBounds ? void 0 : labelMarkBounds.x1) || 0, spaceWidth = null !== (_o = outerLabelSpec.spaceWidth) && void 0 !== _o ? _o : funnel_2.FUNNEL_LABEL_SPACE_WIDTH;
...
FunnelSeries.mark = constant_1.funnelSeriesMark, FunnelSeries.transformerConstructor = funnel_transformer_1.FunnelSeriesSpecTransformer;
